...
class Resolver:
	...
	def startSolvingSudoku(self, grid, i=0, j=0):
		try:
			result = self.solveSudoku(grid, i, j)
			self.main.interface.resolved(result, grid)
		except:
			self.main.interface.resolved(False, grid)
